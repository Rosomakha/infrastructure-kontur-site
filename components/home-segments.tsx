...
const segments: Segment[] = [
  {
    title: "Органам власти и муниципалитетам",
    description:
      "Подготовка и сопровождение заявок на поддержку за счёт федерального бюджета — для всех регионов РФ. ФРТ, КРТ и смежные программы. По этому направлению практика не преследует цель заработать: задача — улучшить жизнь граждан.",
    href: "/organy-vlasti",
    icon: (
      <Icon>
  ...
  {
    title: "Застройщикам и организациям",
    description:
    ...
    <section className="section segments-section" aria-labelledby="segments-heading">
      <div className="container">
        ...
        <p className="lead segments-lead">
          ...
          аудита до ведения проекта от ТУ до акта — включая заявки на
          федеральную поддержку через органы власти регионов и муниципалитетов.
        </p>
