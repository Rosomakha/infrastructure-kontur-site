  ...
  return (
    <footer className="site-footer">
      <div className="container footer-grid">
        <section>
          <h3>Инфраструктурный контур</h3>
          <p>
            Инженерное проектирование, согласования и сопровождение подключений к
            сетям в Москве и Московской области. Аккуратная документация и понятные
            этапы.
          </p>
        </section>
        <section>
          <h3>Реквизиты</h3>
          <ul>
            <li>ООО «Инфраструктурный контур»</li>
