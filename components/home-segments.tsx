...
const segments: Segment[] = [
  {
    ...
    description:
      "Подготовка и сопровождение заявок на поддержку за счёт федерального бюджета: Фонд развития территорий, комплексное развитие территорий и смежные программы.",
